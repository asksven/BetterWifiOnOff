...
public final class EditActivity extends Activity
{
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        if (null == savedInstanceState)
        {
            ...
            {
                ((CheckBox) findViewById(R.id.CheckBoxSetStatus)).setChecked(forwardedBundle.getBoolean(PluginBundleManager.BUNDLE_EXTRA_BOOL_ENABLE));

                Log.i(TAG, "Retrieved from Bundle: " + forwardedBundle.getInt(PluginBundleManager.BUNDLE_EXTRA_BOOL_ENABLE));
            }
        }        
    ...
    public void finish()
    {
        ...
        {
            final boolean enable = ((CheckBox) findViewById(R.id.CheckBoxSetStatus)).isChecked();
            ...
            resultBundle.putBoolean(PluginBundleManager.BUNDLE_EXTRA_BOOL_ENABLE, enable);
            ...
            resultIntent.putExtra(com.twofortyfouram.locale.Intent.EXTRA_STRING_BLURB, "Set status: " + enable);
